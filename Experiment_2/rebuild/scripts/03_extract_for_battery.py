...
GPU / box-only. Ported from Experiment_1's 05_extract + 06_label, generalized to
...
Run:  HF_TOKEN=... python "Experiment_2/rebuild/scripts/03_extract_for_battery.py" --model gemma
"""
...
# Refusal classifier — ported verbatim from Experiment_1's 06_label.py (proven on Gemma).
REFUSAL_MARKERS = [
