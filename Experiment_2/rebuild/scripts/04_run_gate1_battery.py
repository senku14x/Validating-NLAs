...
CPU only. Stress-test without a GPU:
  .venv/bin/python "Experiment_2/rebuild/scripts/04_run_gate1_battery.py" --self-test
Real run (after 03 on the box):
  .venv/bin/python "Experiment_2/rebuild/scripts/04_run_gate1_battery.py" --model gemma
"""
