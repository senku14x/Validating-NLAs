...
break everything downstream if wrong). Ported from Experiment_1's 01_verify_env.
...
Run:  .venv/bin/python "Experiment_2/rebuild/scripts/01_verify_env.py" --model gemma
"""
