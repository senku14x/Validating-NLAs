"""paths.py — canonical paths and file-naming for the Experiment_2 rebuild.
...
# Large gitignored dirs — override on SLURM compute nodes via EXP2_CACHE / EXP2_WORKSPACE
# (home/project trees are often read-only there; use $SCRATCH instead).
CACHE = Path(os.environ.get("EXP2_CACHE", ROOT / "cache"))
WORKSPACE = Path(os.environ.get("EXP2_WORKSPACE", ROOT / "workspace"))
